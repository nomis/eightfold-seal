...
Debounce::Debounce(gpio_num_t pin, bool active_low, bool pull_active,
	...
	config.pull_up_en = (active_low_ ^ pull_active) ? GPIO_PULLUP_ENABLE : GPIO_PULLUP_DISABLE;
	config.pull_down_en = (active_low_ ^ pull_active) ? GPIO_PULLDOWN_DISABLE : GPIO_PULLDOWN_ENABLE;
