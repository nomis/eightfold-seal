...
#ifndef CONFIG_OCTAVO_SWITCH_PULL_ACTIVE
#define CONFIG_OCTAVO_SWITCH_PULL_ACTIVE 0
#endif
static constexpr const bool SWITCH_PULL_ACTIVE = CONFIG_OCTAVO_SWITCH_PULL_ACTIVE;
